...
const stmts = {
  ...
  getPublicUsers: db.prepare(`SELECT id, username, role, created_at FROM users ORDER BY role DESC, created_at ASC`),
  getPublicUsers: db.prepare(`SELECT id, username, role, created_at FROM users ORDER BY role ASC, created_at DESC`),
